...
if os.environ.get("P2P") is None:
    pytest.skip(allow_module_level=True)

#todo: relies on 'ports: [ "3001:3000" ]' in peer bundler.
BUNDLER2 = "http://localhost:3001/rpc"

#todo: this can only work if the script runs inside the docker-compose environment.
